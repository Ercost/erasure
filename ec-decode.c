                                 ...
                                 uint8_t ***target)
{
        ...
        uint8_t **tmp_source = (uint8_t **)malloc( sizeof(uint8_t *)*k) ;
        uint8_t **tmp_target = (uint8_t **)malloc( sizeof(uint8_t *)*m) ;
                        ...
                        uint32_t **decode_index)
{
        ...
        uint8_t *tmp_decode_matrix =  (uint8_t *)malloc(sizeof(uint8_t)*k*n);
        uint8_t *tmp_decode_tbls = (uint8_t *)malloc(sizeof(uint8_t)*k*n*32);
